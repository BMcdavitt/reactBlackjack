...
export default function PlayPage(props) {
  ...
  function hit() {
    ...
    if (handValue(newHand) === 21) {
      ...
      updateGameState({ ...gameState, playerCards: newHand, handState: 'Bust', bank: newBank })
    } else {
      updateGameState({ ...gameState, playerCards: newHand })
    }
  }
  ...
  function stand() {
    ...
    updateGameState({ ...gameState, dealerCards: completeHand, handState: newState, bank: newBank, currentBet: newBet })
  }
  ...
  function increaseBet() {
    ...
    updateGameState({ ...gameState, currentBet: newBet })
  }
    ...
    <div className="playTable">
      ...
      <div className="playerHand">
        <div className="playerHandInfo">
          <div>
            Player hand : {handValue(gameState.playerCards)} {gameStateDisplay()}
          </div>
        </div>
        {playerHandDisplay}
      </div>
      ...
      <div className="playerBank">
        ...
        <div class="action" onClick={increaseBet}>
          Bet More
        </div>
        <div class="action" onClick={decreaseBet}>
          Bet Less
        </div>
      </div>
    </div>
